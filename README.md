...
![SQL](https://img.shields.io/badge/sql-%23003B57.svg?style=flat-square&logo=mysql&logoColor=white)
...
![Vuforia](https://img.shields.io/badge/Vuforia-8B8B8B?style=flat-square)
...
- 👓 **Face Shape-Based Virtual Eyewear Try-On System** An intelligent web-based system that classifies users' face shapes using a CNN model to recommend suitable eyewear styles. Integrated a Flask backend with a WebAR frontend for a real-time augmented reality try-on experience.
